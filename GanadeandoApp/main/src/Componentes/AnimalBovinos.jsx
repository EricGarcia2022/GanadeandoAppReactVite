      ...
      <body>
        ...
        <form className="formulario">
          ...
          <div className="AnimalBovino">
            <img src="/img/cinco.jpg" width="300px" height="250px" />
            <div className="message">
              <button className="sign-up-btn">
                <img src="/img/Registrar.svg" alt="" width="20px" height="20px" />
                <a href="/html/Registrar.html">Registrar</a>
              </button>
              <button className="sign-up-btn">
                <img src="/img/Actualizar.svg" alt="" width="20px" height="20px" />
                <a href="/html/Actualizar.html">Actualizar</a>
              </button>
              <button className="sign-up-btn">
                <img src="/img/Consultar.svg" alt="" width="20px" height="20px" />
                <a href="/html/Consultar.html">Consultar</a>
              </button>
              <button className="sign-up-btn">
                <img src="/img/Eliminar.svg" alt="" width="20px" height="20px" />
