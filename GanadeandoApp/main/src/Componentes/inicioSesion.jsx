...
const Formulario = () => {
  return (
    <form className="formulario">
      ...
      <button className="sign-up-btn" onClick={Registro}>Registrarse</button>
      </form>
...
//const Iconos = () => {
  //return (
    //<div className="iconos">
      ////<BoxIcon type="logo" name="facebook-circle" color="white" />
      //</div>
     // <div className="border-icono">
       // <BoxIcon type="logo" name="instagram" color="white" />
      //</div>
      //<div className="border-icono">
        //<BoxIcon type="logo" name="twitter" color="white" />
      //</div>
    //</div>
  //);
//};
